...
namespace Controllers\Admin {
    ...
    class Dashboard {
        ...
        public function authScreen($odin_add_menu) {
            add_action('admin_menu', function() use ($odin_add_menu) {
                return $this->build_page_auth($odin_add_menu);
            });
        }

        //Private Methods
        private function build_page($oam, $twigBuilder = null) {
            $menu = $oam;
...
//            });
        ...
        private function build_page_auth($oam) {
            $menu = $oam;
            $menu->add_menu("umbrella", "Umbrella", $capability = 'manage_options', function() {
                return $this->adminAuthScreenTemplate();
            }, 'data:image/svg+xml;base64,');
        }
        ...
        private function adminAuthScreenTemplate() {
            echo $this->template_sys->render('/Admin/authentication.twig', array(
                'teste' => 'hello world'
                    )
            );
        }
