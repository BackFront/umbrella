...
namespace Controllers\Admin {
    ...
    class Dashboard
    {
        ...
        private function build_admin_menu($oam, $twigBuilder = null)
        {
            ...
            $submenu->add_submenu("umbrella/signup", $menu, "Cadastrar", "Cadastrar", "manage_options", function() {
                return $this->adminSignupTemplate();
            });
        }
        ...
        private function adminSignupTemplate()
        {
            global $twig;
            echo $this->template_sys->render('signup.twig', array(
                'testo' => 1
                    )
            );
        }
