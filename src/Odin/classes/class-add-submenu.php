...
class Odin_Add_Submenu {
     ...
     * <h1>add_menu</h1>
     * 
     * $object->add_menu($id, $title, $capability = 'manage_options', $callback_menu = null, $dashicon = '', $position = null)
     */
    public function add_menu($id, $title, $capability = 'manage_options', $callback_menu = null, $dashicon = '', $position = null) {
        $this->id = $id;
        $this->title = $title;
        $this->capability = $capability;
        $this->dashicon = $dashicon;

        $callback_menu = ($callback_menu)? : array($this, "settings_page");
        add_menu_page($this->title, $this->title, $this->capability, $this->id, $callback_menu, $this->dashicon, $position = null);
    }

    /**
     * <h1>add_submenu</h1>
     * 
     * $object->add_submenu($id, $page_title, $menu_title, $capability = 'manage_options', $callback_menu = null)
     * 
     * @param object $object_menu       | (Required) The object menu
     * @param string $page_title        | (Required) The text to be displayed in the title tags of the page when the menu is selected.
     * @param string $menu_title        | (Required) The text to be used for the menu.
     * @param string $capability        | (Required) The capability required for this menu to be displayed to the user.
     * @param callable $callback_menu   | (Optional) The function to be called to output the content for this page.
     */
    public function add_submenu($id, $object_menu, $page_title, $menu_title, $capability = 'manage_options', $callback_menu = null) {
        $callback_menu = ($callback_menu)? : array($this, "settings_page");
        add_submenu_page($object_menu->id, $page_title, $menu_title, $capability, $id, $callback_menu);
    }
