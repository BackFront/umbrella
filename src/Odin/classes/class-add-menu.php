...
class Odin_Add_Menu {
    ...
    public function add_menu($id, $title, $capability = 'manage_options', $dashicon = '') {
        $this->id = $id;
        $this->title = $title;
        $this->capability = $capability;
        $this->dashicon = $dashicon;
        add_menu_page($this->title, $this->title, $this->capability, $this->id, array(&$this, 'settings_page'), $this->dashicon);
    }
